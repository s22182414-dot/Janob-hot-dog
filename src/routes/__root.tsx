  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Nimadir noto'g'ri ketdi. Sahifani yangilang yoki bosh sahifaga qayting.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Janob Hot-Dog — Toshkentdagi hot-dog kafesi" },
      {
        ...
        content: "Jonli olovda pishirilgan hot-doglar, lavash dog va kartoshka fri. Onlayn buyurtma bering.",
      },
