...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Bizning tariximiz — Janob Hot-Dog kafesi" },
      {
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
        <div className="animate-rise">
          ...
          <p className="mt-6 leading-relaxed text-muted-foreground">
            Janob Hot-Dog Amir Temur xiyoboni yaqinidagi burchakda bitta ko'mir grili bilan
            boshlangan. Asoschimiz uy ta'mini beradigan hot-dog yaratmoqchi edi — jonli olovda
            pishirilgan mol go'shtli sosiska, yumshoq bulochka o'rniga tandir non va chakka, sumalak
            hamda yangi ko'katlardan tayyorlangan souslar.
          </p>
          <p className="mt-4 leading-relaxed text-muted-foreground">
            Bugun ham kafemiz ataylab kichik. Hamma narsa har tong yangidan tayyorlanadi, hech nima
            lampa ostida kutib turmaydi va har bir buyurtma yetti daqiqada tayyor bo'ladi.
          </p>
          <div className="mt-8 grid grid-cols-3 gap-3">
            {stats.map((s) => (
              <div key={s.label} className="glass rounded-2xl p-4">
                <p className="font-display text-ember-gradient text-2xl font-bold">{s.value}</p>
