...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Aloqa va manzil — Janob Hot-Dog, Toshkent",
      },
      {
...
const info = [
  {
    icon: MapPin,
    title: "Manzil",
    lines: ["Amir Temur ko'chasi 24", "Toshkent, O'zbekiston"],
  },
  { icon: Clock, title: "Ish vaqti", lines: ["Har kuni", "10:00 – 00:00"] },
  {
    icon: Phone,
    title: "Qo'ng'iroq qiling",
    lines: ["+998 90 123 45 67", "Yetkazib berish va keytering"],
  },
];
    ...
    <section className="relative px-4 pt-16 pb-28 sm:px-6 md:pt-40">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <p className="animate-rise mt-4 max-w-lg text-muted-foreground">
          Peshtaxta yonida o'tiring, grilni tomosha qiling yoki Toshkent markazi
          bo'ylab yetkazib beramiz.
        </p>
